...
another. 
\item Thus, the prefix-free codes 2, 4, and 6 are uniquely decodable codes. Note that the prefix -free
condition is not a necessary condition for unique decodability. 
\item For example, code 5 does
...
\begin{itemize} 
\item A uniquely decodable code is called an instantaneous code if the end of any code word is
